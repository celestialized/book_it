...
class ConsultantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultant" do
    assert_difference('Consultant.count') do
      post consultants_url, params: { consultant: { bio: @consultant.bio, first_name: @consultant.first_name, last_name: @consultant.last_name, phone: @consultant.phone, user_id: @consultant.user_id } }
    end
  ...
  test "should update consultant" do
    patch consultant_url(@consultant), params: { consultant: { bio: @consultant.bio, first_name: @consultant.first_name, last_name: @consultant.last_name, phone: @consultant.phone, user_id: @consultant.user_id } }
